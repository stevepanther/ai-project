          ...
          <section className="container px-4 py-6 mx-auto md:px-6 lg:py-24 ">
            <div className="grid gap-8 md:grid-cols-3">
              {feature.map((feature) => (
                <div
                  key={feature.id}
                  className="flex flex-col items-center text-center bg-gradient-to-br from-purple-100 to-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
                >
